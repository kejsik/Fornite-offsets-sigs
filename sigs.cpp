ProjectWorldToScreen: 40 53 55 56 57 41 56 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 84 24 ? ? ? ? 33 DB 45 8A F1 49 8B F8 48 8B EA 48 8B F1 48 85 C9 0F 84
...
LineSightOfTo : 48 8B C4 48 89 58 20 55 56 57 41 54 41 56 48 8D 68 B8 48 81 EC ?? ?? ?? ??

FNAME : 48 83 EC 28 80 3D ? ? ? ? ? 74 0C 48 8D 05 ? ? ? ? 48 83 C4 28 C3

if FNAME = null - try with : 48 8D 0D ? ? ? ? E8 ? ? ? ? C6 05 ? ? ? ? ? 48 83 C4 28 C3
